...
Version: 1.0.0
Author: Mean, Median, Mode Calculator / www.calculator.io
...
function display_calcio_ci_mean_median_mode_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_mean_median_mode_calculator', 'display_calcio_ci_mean_median_mode_calculator' );